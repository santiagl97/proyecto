...
public class EstructurasDeDatos {
   ...
   /* public static void main(String[] args) {
    ...
    Ciclos ni= new Ciclos ();
    ni.numerosimpares1hasta100();
    
    Ciclos mh= new Ciclos ();
    mh.mostrar1hasta100();
    
    Ciclos as= new Ciclos ();
    as.numeroasteriscos();
   ...
   /*public static void main(String[] args) {
    ...
    Condicionales pa= new Condicionales();
    pa.numerosparesahastab();
    
    Condicionales mu= new Condicionales();
    mu.multiplicacionahastab();
